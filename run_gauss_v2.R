# Varying-intercept model for GPS coordinates
# Robert Kubinec
...
# Too much data, just keep 20,000 rows
join_data <- sample_n(join_data,20000)


# run mclust on latitude/longitude to find distinct geographical areas/clusters
...
# Need to create a predictor matrix and an outcome variable from a formula that drops all missing rows/data
...
# Run a varying group means model according to clusters we have identified
